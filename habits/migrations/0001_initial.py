    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.CharField(blank=True, max_length=300, null=True, verbose_name='место')),
                ...
                ('time_to_complete', models.DurationField(blank=True, default=datetime.timedelta(seconds=180), null=True, verbose_name='время на выполнение')),
